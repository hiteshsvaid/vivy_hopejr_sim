...
VISUAL_ONLY_PARTS = [
    ...
    'arm_v2-head_base_clone',
    'arm_v2-head_pan_clone',
    'arm_v2-head_pan_STS3215_servo_clone',
    'arm_v2-head_tilt_clone',
    'arm_v2-head_tilt_STS3215_servo_clone',
    'arm_v2-head_tilt_camera_holder_assembly',
    ...
    'arm_v2-wrist_new_right_clone',
    'arm_v2-wrist_palm_servo',
    'arm_v2-wrist_yaw_pitch_left',
    'palm_base',
    'arm_v2-palm_base_clone',
    'arm_v2-palm_new_right_clone',
    'arm_v2-wrist_servo_sts3215_left',
    'arm_v2-palm_base_left',
    'arm_v2-thumb_right_servo',
    'arm_v2-index_right_servo',
    'arm_v2-thumb_servo_sts3215_left',
    'arm_v2-index_servo_sts3215_left',
    'arm_v2-thumb_clone',
    'arm_v2-thumb_left',
    'arm_v2-index_clone',
    'arm_v2-index_left',
